...
To load the data for today's lecture, **make sure you've got the 'data/data.Rdata' file downloaded** into the same working directory you defined in the setup section, then run these lines of code:
...
In Part 0, we learned that it is useful for future analyses to account for checklists that *don't* have a certain species, as well as those that do. All those zeroes, however, will mess up this frequency analysis; every species will be 'present' in every checklist, even if their 'presence' is at zero abundance. 
...
![Yellow-rumped warbler, Setophaga coronata. Photo from eBird.com](../images/yrw.jpg)
...
![Range of the yellow-rumped warbler. The Myrtle subspecies is found in the east. Photo from eBird.com](../images/range.jpg)
